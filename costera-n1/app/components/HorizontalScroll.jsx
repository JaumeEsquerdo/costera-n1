    ...
    <section ref={targetRef} className="relative h-[460vh] bg-slate-900">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        <motion.div style={{ x }} className="flex">
          ...
          <div className="relative w-[120vw] h-screen shrink-0 flex flex-col items-center justify-between bg-blue-300 pt-24 pr-20 pl-10 lg:flex-row">
            <div
              aria-label="hidden "
              ...
              <div className="flex flex-col gap-4 lg:gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <p className="text-balance">
                    Te alojas en la Costera de la Mar, la calle más fotografiada
                    y vibrante de Villajoyosa. Este eje histórico no es solo una
          ...
          <div className="relative w-[120vw] h-screen shrink-0 flex flex-col items-center justify-between bg-orange-300 pt-24 pr-20 pl-10 lg:flex-row">
            <div
              aria-label="hidden "
              ...
              <div className="flex flex-col gap-4 lg:gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <p className="text-balance">
                    ...
                    Marítimo y la Playa Centro. En menos de 5 minutos pasarás
                    del silencio de las calles empedradas al bullicio del
                    Mediterráneo.
                  </p>
                  <p className="text-balance">
                    {" "}
          ...
          <div className="relative w-[120vw] h-screen shrink-0 flex flex-col justify-between bg-red-300 pt-24 pr-10 pl-10 lg:flex-row">
            <div
              aria-label="hidden "
              ...
              <div className="flex flex-col gap-4 lg:gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <p className="text-balance">
                    ...
                    esquina de las mejores tabernas tradicionales y arrocerías
                    del puerto. Además, el aroma a chocolate artesanal te guiará
                    en un paseo hacia las fábricas históricas de la ciudad. Una
                    ubicación privilegiada para los amantes de la buena mesa y
                    la vida de barrio auténtica.
                  </p>
                </div>
              </div>
            </div>
            <Image
              ...
              height={400}
              alt=""
              className="object-cover lg:w-80 lg:h-120"
            />
            <Image
              src="/hotel-fachada.webp"
              width={400}
              height={400}
              alt=""
              className="object-cover hidden lg:block lg:w-120 lg:h-160"
            />
          </div>
        </motion.div>
      </div>
