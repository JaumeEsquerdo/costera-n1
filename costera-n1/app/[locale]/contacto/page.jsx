...
export default function Contacto() {
  return (
    <>
      <Header />
      <main className="flex flex-col min-h-screen w-[90%] max-w-8xl mx-auto">
        <div className="pt-40">
          <h1 className="text-4xl font-title text-center w-full">
            Contáctanos
          </h1>
        </div>
        <div className="mt-auto py-8 flex flex-col gap-12">
          <div className="w-full flex flex-col items-center justify-end">
            <div className="relative w-90 max-w-[90%] h-60 lg:w-85 lg:h-50 overflow-hidden ">
              <Image
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col w-full gap-2">
              <div className="flex flex-col w-full items-center justify-center gap-6 lg:gap-8">
              ...
              <div className="hidden lg:inline relative w-90 h-60 lg:w-85 lg:h-50 overflow-hidden">
                <Image
                  src="/hotel-fachada.webp"
                  fill
                  priority
